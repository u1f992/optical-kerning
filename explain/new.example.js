...
const fontFamily = "Zen Kaku Gothic Antique"; // "Noto Serif JP"
const font = {
  fontFamily,
  fontStyle: "normal",
  fontWeight: "400",
...
const cache = fs.existsSync("cache.json")
  ? importSpacingCache(fs.readFileSync("cache.json", { encoding: "utf-8" }))
  : createSpacingCache();
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Serif+JP:wght@200..900&family=Zen+Kaku+Gothic+Antique&display=swap" rel="stylesheet">
</head>
<body>
  <p style='font-family: ${fontFamily}'>${text}</p>
...
fs.writeFileSync("cache.json", exportSpacingCache(cache));
